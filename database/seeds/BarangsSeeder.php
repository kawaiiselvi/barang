...
class BarangsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $barang1=Barang::create(['title'=>'Mouse','amount'=>3, 'stock'=>2, 'kondisi'=>'baru', 'kategori'=>'perangkat keras', 'penanggung_id'=>$penanggung1->id]);
        $barang2=Barang::create(['title'=>'Keyboard','amount'=>5, 'stock'=>2, 'kondisi'=>'bekas', 'kategori'=>'perangkat keras', 'penanggung_id'=>$penanggung2->id]);
